...
export default function NavBar() {
    return (
        <nav>
            ...
            <div className="left-[532px] top-[50px] absolute justify-start items-start gap-10 inline-flex">
                ...
                <div className="text-right text-white text-opacity-70 text-lg font-normal font-['Nunito Sans'] overflow-visible w-10"><p>Our Project</p></div>
                <div className="text-right text-white text-opacity-70 text-lg font-normal font-['Nunito Sans'] overflow-visible w-10"><p>About us</p></div>
            </div>
